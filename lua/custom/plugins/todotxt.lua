...
--   cmd = { 'TodoTxt', 'DoneTxt' },
--   dir = vim.fn.resolve(vim.fn.expand '~/projects/todotxt.nvim/'),
--   dev = true,
--   opts = {
--     todotxt = vim.fn.resolve(vim.fn.expand '~/vaults/todo.txt'),
--     donetxt = vim.fn.resolve(vim.fn.expand '~/vaults/done.txt'),
--     create_commands = true,
--   },
--   keys = {
--     { '<leader>tt', '', desc = '+todo.txt' },
