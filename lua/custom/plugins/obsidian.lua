  ...
  },
  {
    ...
    config = function(_, opts)
      ...
      wk.add {
        ...
        { '<leader>od', '<cmd>Obsidian dailies -10 0<cr>', desc = 'Daily notes' },
        ...
        { '<leader>om', '<cmd>Obsidian template<cr>', desc = 'Template' },
        { '<leader>on', '<cmd>Obsidian quick_switch nav<cr>', desc = 'Nav' },
        { '<leader>or', '<cmd>Obsidian rename<cr>', desc = 'Rename' },
        { '<leader>oc', '<cmd>Obsidian toc<cr>', desc = 'Contents (TOC)' },
        -- {
        --   '<leader>ow',
        --   function()
